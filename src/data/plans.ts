...
export const homePlans: HomePlan[] = [
  {
    ...
    elevationImg: '/plans/brownstone-elevation.jpg?v=drive3',
    cutoutImg: '/plans/cutouts/brownstone.png?v=drive3',
  ...
  },
  {
    ...
    builder: 'Blackstone Homes',
    elevationImg: '/plans/whitestone-elevation.jpg?v=drive3',
    cutoutImg: '/plans/cutouts/whitestone.png?v=drive3',
    ...
    highlights: [
      ...
      'Front-facing garage doors toward the street',
    ],
