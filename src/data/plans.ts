...
export const homePlans: HomePlan[] = [
  {
    ...
    elevationImg: '/plans/brownstone-elevation.jpg?v=drive4',
    cutoutImg: '/plans/cutouts/brownstone.png?v=drive4',
  ...
  },
  {
    ...
    builder: 'Blackstone Homes',
    elevationImg: '/plans/whitestone-elevation.jpg?v=drive4',
    cutoutImg: '/plans/cutouts/whitestone.png?v=drive4',
