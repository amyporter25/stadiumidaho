...
export const homePlans: HomePlan[] = [
  {
    ...
    elevationImg: '/plans/brownstone-elevation.jpg?v=drive7',
    cutoutImg: '/plans/cutouts/brownstone.png?v=drive7',
  ...
  },
  {
    ...
    builder: 'Blackstone Homes',
    elevationImg: '/plans/whitestone-elevation.jpg?v=drive7',
    cutoutImg: '/plans/cutouts/whitestone.png?v=drive7',
