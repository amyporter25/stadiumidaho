...
export const homePlans: HomePlan[] = [
  {
    ...
    elevationImg: '/plans/brownstone-elevation.jpg?v=drive9',
    cutoutImg: '/plans/cutouts/brownstone.png?v=drive9',
  ...
  },
  {
    ...
    builder: 'Blackstone Homes',
    elevationImg: '/plans/whitestone-elevation.jpg?v=drive9',
    cutoutImg: '/plans/cutouts/whitestone.png?v=drive9',
