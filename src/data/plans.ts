...
export const homePlans: HomePlan[] = [
  {
    ...
    elevationImg: '/plans/brownstone-elevation.jpg?v=drive5',
    cutoutImg: '/plans/cutouts/brownstone.png?v=drive5',
  ...
  },
  {
    ...
    builder: 'Blackstone Homes',
    elevationImg: '/plans/whitestone-elevation.jpg?v=drive5',
    cutoutImg: '/plans/cutouts/whitestone.png?v=drive5',
