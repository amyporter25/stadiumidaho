...
export const homePlans: HomePlan[] = [
  {
    ...
    elevationImg: '/plans/brownstone-elevation.jpg?v=drive6',
    cutoutImg: '/plans/cutouts/brownstone.png?v=drive6',
  ...
  },
  {
    ...
    builder: 'Blackstone Homes',
    elevationImg: '/plans/whitestone-elevation.jpg?v=drive6',
    cutoutImg: '/plans/cutouts/whitestone.png?v=drive6',
