...
export const homePlans: HomePlan[] = [
  {
    ...
    elevationImg: '/plans/brownstone-elevation.jpg?v=drive8',
    cutoutImg: '/plans/cutouts/brownstone.png?v=drive8',
  ...
  },
  {
    ...
    builder: 'Blackstone Homes',
    elevationImg: '/plans/whitestone-elevation.jpg?v=drive8',
    cutoutImg: '/plans/cutouts/whitestone.png?v=drive8',
